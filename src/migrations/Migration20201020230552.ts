...
export class Migration20201020230552 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "billboard" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "date_now" timestamptz(0) not null, "show_date" timestamptz(0) not null, "status" bool not null default true, "capacity" int4 not null);');

    this.addSql('create table "ticket" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "description" varchar(255) not null, "pricing" int4 not null, "status" bool not null default true);');
    ...
    this.addSql('create table "product_type" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "description" text not null);');

    this.addSql('create table "product" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "description" varchar(255) not null, "price" int4 not null, "status" bool not null default true, "type_id" int4 not null);');
    ...
    this.addSql('create table "product_classification" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "type" varchar(255) not null, "description" varchar(255) not null, "added_price" int4 not null);');
    ...
    this.addSql('create table "movie_classification" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "type" varchar(255) not null, "description" varchar(255) not null);');

    this.addSql('create table "movie" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "synopsis" text not null, "image_url" varchar(255) not null, "banner_url" varchar(255) not null, "status" bool not null default true, "classification_id" int4 not null, "billboard_id" int4 not null);');
    ...
    this.addSql('create table "location" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "location" varchar(255) not null, "description" varchar(255) not null, "billboard_id" int4 not null);');

    this.addSql('create table "genre" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "description" varchar(255) null);');
    ...
    this.addSql('create table "reservation" ("id" serial primary key, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "date_now" timestamptz(0) not null, "tax" int4 not null, "total" int4 not null, "status" bool not null default true, "user_id" int4 not null);');
    ...
    this.addSql('alter table "movie" add constraint "movie_billboard_id_foreign" foreign key ("billboard_id") references "billboard" ("id") on update cascade;');
    ...
    this.addSql('alter table "location" add constraint "location_billboard_id_foreign" foreign key ("billboard_id") references "billboard" ("id") on update cascade;');
